...
public class TestCart {
	...
	public void testVerifyPriceInCartWithMultipleProducts() throws InterruptedException {
		try {
			...
			//Vänta och klicka på lägg produkt i varukorgen
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='content']/div[4]/div/div/ul/li[2]/div/a")));
			String firstProductName = driver.findElement(By.xpath(".//*[@id='content']/div[4]/div/div/ul/li[2]/div/div/a/div[3]/span")).getText();
			System.out.println(firstProductName);
			driver.findElement(By.xpath(".//*[@id='content']/div[4]/div/div/ul/li[2]/div/a")).click();
			
			//Lägg in en till produkt i varukorgen
			String secondProductName = driver.findElement(By.xpath(".//*[@id='content']/div[4]/div/div/ul/li[3]/div/div/a/div[3]/span")).getText();
			...
			int firstPrice = Integer.parseInt(driver.findElement(By.xpath("(.//*[@class='subtotal'])[1]")).getText().replace(",00", ""));
			int secondPrice = Integer.parseInt(driver.findElement(By.xpath("(.//*[@class='subtotal'])[2]")).getText().replace(",00", ""));
			int totalOfFirstAndSecondPrice = firstPrice + secondPrice;
			
			
			System.out.println("Totalpriset är: " + totalOfFirstAndSecondPrice + "kr");
			//Tar ut totalpris
			int totalPrice = Integer.parseInt(driver.findElement(By.xpath(".//*[@id='basket']/footer/div/div[1]/table/tfoot/tr[1]/th[2]")).getText().replaceAll(",00", ""));
